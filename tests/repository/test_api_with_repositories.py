"""
Интеграционные тесты для API endpoints с репозиториями
"""
...
class TestAPIIntegration:
    ...
    async def test_ask_endpoint(
        self, mock_cache, mock_llm, client: AsyncClient, sample_embedding: list
    ):
    ...
    @pytest.mark.asyncio
    async def test_statistics_empty_database(self, client: AsyncClient):
        """Тест статистики для пустой БД"""
